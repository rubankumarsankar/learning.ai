      ...
      <main className="grid gap-6 md:gap-8">
        ...
        {lesson.codeExample && (
          <section className="mt-8 md:mt-12">
            <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-yellow-400 flex items-center gap-2">
              <span>💻</span> WORKING EXAMPLE
            </h2>
            <div className="rounded-xl overflow-hidden border border-gray-700 shadow-2xl bg-[#0d1117]">
              ...
              <div className="bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-gray-700 select-none">
                ...
                <div className="ml-4 text-xs font-mono text-gray-400 flex-1 text-center pr-12">
                  code_editor
                </div>
              </div>
